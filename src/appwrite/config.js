...
export class DatabaseService{
    ...
    async updatePost(slug,{title,content,featuredImage,status}){
        try {
            ...
            console.log("UpdatePost DatabaseService :: updatePost :: error :: ",error);
        }
    }
    ...
    async getPosts(queries = [Query.equal("status","active")]){   //indexes use cheste ne queries use cheyochu
        try {
